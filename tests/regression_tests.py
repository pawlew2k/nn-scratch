...
def activation_regression(hf: str = SIGMOID, lf=MSE):
    ...
    regression(train_path, test_path, model, hidden_function, epochs=300, include_bias=include_bias,
               plot_path=plot_path, display_information=f"Activation: {lf}")


def cube_regression(hf: str = SIGMOID, lf=MSE):
    ...
    regression(train_path, test_path, model, hidden_function=hidden_function, epochs=300, include_bias=include_bias,
               plot_path=plot_path, savefig=False, display_information=f"Cube: {lf}")
